package com.xgdfin.workflow.common.config;
...
import com.xgdfin.workflow.common.utils.YamlUtil;
...
public class Global
{
    ...
    {
        return StringUtils.nvl(getConfig("gen.packageName"), "com.xgdfin.workflow.project.module");
    }
