...
public interface SysUserMapper
{
     ...
     * @version 1.0
     */
	public List<SysUser> selectUserByRoleId(Map<String, Object> map);
	 ...
	 * @version 1.0
	 */
	public List<SysUser> selectUserByIds(List<Long> list);
